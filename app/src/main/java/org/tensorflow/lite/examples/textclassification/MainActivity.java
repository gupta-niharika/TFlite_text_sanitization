        ...
        () -> {
          ...
          for (int i = 0; i < results.size(); i++) {
            ...
            textToShow += String.format("    %s: %s\n", result.getTitle(), result.getConfidence());
              Toast.makeText(MainActivity.this, result.getConfidence().toString(), Toast.LENGTH_SHORT).show();
              Log.e(TAG, "showResult: "+ result.getConfidence());
              if(result.getConfidence() < 0.40) {
                  Log.e(TAG, "this was a bad word: " );
              }
          }
          textToShow += "---------\n";
