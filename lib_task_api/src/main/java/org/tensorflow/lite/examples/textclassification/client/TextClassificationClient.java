...
//      Log.e(TAG, "classify: " + apiResults.get(0) );
//    }
    Category category = apiResults.get(0);
    results.add(new Result("", category.getLabel(), category.getScore()));
    Log.e(TAG, "classify: " + results );
